...
function Home() {
  ...
  return (
    <Layout>
      ...
      <section className='flex flex-col-reverse items-center justify-center p-5 md:flex-row md:gap-7 bg-gradient-to-r from-amber-50 to-orange-300'>
      ...
      <section className='py-4 mt-6 bg-gradient-to-r from-amber-50 to-orange-300'>
        ...
        <div className='container flex flex-col md:flex-row'>
          ...
          <div className='flex flex-col items-center justify-center rounded-lg lg:w-1/2'>
            <img src={CookingImage} alt="Cooking" width={500} className='rounded-xl'/>
          </div>

          <div className='flex flex- flex-wrap text-lg lg:w-1/2 lg:pl-12 lg:text-center'>
