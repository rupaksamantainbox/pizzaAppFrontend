                    ...
                    <form className='flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2'>
                        ...
                        <div className="relative mb-4">
                            ...
                            <input 
                                ...
                                minLength={5}
                                placeholder="John"
                                className="w-full px-3 py-1 mt-2 text-base leading-8 text-gray-700 
                                transition-colors duration-200 ease-in-out border border-gray-300 rounded 
                                outline-noe focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200" 
                            />
                        </div>
                        ...
                        <div className="relative mb-4">
                            ...
                            <input 
                                ...
                                rounded outline-noe focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200" 
                            />
                        </div>
                        ...
                        <button 
                            ...
                            className="w-full px-8 py-2 text-lg text-white bg-yellow-500 border-0 rounded 
                            focus:outline-none hover:bg-yellow-600">
                            Create Account
                        </button>
